...
<main id="primary" class="site-main">
    ...
    <?php
    $info = get_option('info_colegio_settings');
    $mision = $info['mision'] ?? 'Formar integralmente a nuestros estudiantes mediante una educación de calidad basada en valores, desarrollando sus capacidades intelectuales, emocionales y sociales para que se conviertan en ciudadanos responsables, críticos y comprometidos con la transformación positiva de la sociedad.';
    ?>
                    ...
                    <div
                        ...
                        <svg viewBox="0 -0.5 1025 1025" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <g id="SVGRepo_iconCarrier">
                                <!-- Todo el SVG queda igual -->
                                <path d="M447.427363 576.572637m-431.447814 0a431.447814 431.447814 0 1 0 862.895628 0 431.447814 431.447814 0 1 0-862.895628 0Z" fill="#FFFFFF"></path>
                                <path d="M447.427363 1024c-246.884027 0-447.427363-200.543336-447.427363-447.427363s200.543336-447.427363 447.427363-447.427363 447.427363 200.543336 447.427363 447.427363-200.543336 447.427363-447.427363 447.427363z m0-862.895628c-229.306523 0-415.468266 186.161742-415.468266 415.468265s186.161742 415.468266 415.468266 415.468266 415.468266-186.161742 415.468265-415.468266-186.161742-415.468266-415.468265-415.468265z" fill="#191919"></path>
                                <path d="M447.427363 576.572637m-324.384838 0a324.384838 324.384838 0 1 0 648.769676 0 324.384838 324.384838 0 1 0-648.769676 0Z" fill="#F86C6C"></path>
    ...
    <section class="py-16 md:py-20 bg-gray-50 dark:bg-gray-800">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row-reverse items-center gap-12">
                ...
                <div class="lg:w-1/3 text-center lg:text-left">
                    <div
                        ...
                        <svg fill="#E2BD38" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width="68px"
                            xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32.148 32.148" xml:space="preserve">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <g>
                                    <g>
                                        <!-- ⭐ TODO el SVG exactamente como lo enviaste ⭐ -->
                ...
                <!-- Columna del texto de la visión -->
                <div class="lg:w-2/3">
                    <div class="bg-white dark:bg-gray-900 rounded-3xl p-8 md:p-12 border-l-8 border-brand-secondary-500">
                        <p class="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed">
                            ...
                            echo esc_html(
                                $info['vision']
                                    ?? 'Ser reconocidos como una institución educativa líder en la formación de personas íntegras e innovadoras.'
                            );
                            ?>
                        </p>
                    </div>
                    ...
                    <?php foreach ($valores as $valor): ?>
                        <div
                            ...
                            <h3
                                ...
                                <?php echo esc_html($valor['nombre'] ?? ''); ?>
                            </h3>
