                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex gap-2 pb-3 border-b border-gray-200 dark:border-slate-700">
                            ...
                            <div>
                                ...
                                <p class="text-text-light dark:text-text-dark">
                                    <?php echo $direccion ? nl2br(esc_html($direccion)) : '<span class="text-gray-500">Dirección no registrada</span>'; ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-2 pb-3 border-b border-gray-200 dark:border-slate-700">
                            ...
                            <div>
                                ...
                                <p class="text-text-light dark:text-text-dark">
                                    ...
                                    <?php else: ?>
                                        <span class="text-gray-500">Teléfono no registrado</span>
                                    <?php endif; ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="pt-6 text-center">
                            ...
                            <?php else: ?>
                                <p class="text-gray-500 text-sm">Ubicación no disponible</p>
                            <?php endif; ?>
                        </div>
