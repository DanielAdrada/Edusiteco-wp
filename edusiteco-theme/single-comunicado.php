    ...
    <?php if (have_posts()):
        while (have_posts()):
            ...
            if (!empty($categories)) {
                ...
                $archive_link = get_category_link($primary_category->term_id);
                $texto = 'Volver a ' . $primary_category->name;
            }
            ?>
            ...
            <?php if ($archive_link): ?>
                <div class="mt-10">
                    <a
                        ...
                        <span class="group-hover:text-blue-800 group-hover:underline transition-colors">
