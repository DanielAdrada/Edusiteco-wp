                            ...
                            <div class="p-6">
                                ...
                                <div class="flex flex-col items-center text-center">
                                    ...
                                    <div class="foto-redonda">
                                        ...
                                        <?php if (!empty($d['foto'])) : ?>
                                            <img
                                                src="<?php echo esc_url($d['foto']); ?>"
                                                alt="<?php echo esc_attr($d['nombre']); ?>"
                                                class="w-full h-full object-cover object-center">
                                        <?php else : ?>
                                            <div class="w-full h-full flex items-center justify-center bg-brand-primary-600 text-white text-xl font-bold">
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    ?>
                        ...
                        <article
                            class="group bg-white dark:bg-gray-700 rounded-lg shadow-md 
                            ...
                            <div class="p-6 text-center flex flex-col h-full">
                                ...
                                <?php if (!empty($a['correo'])) : ?>
                                    <a href="mailto:<?php echo esc_attr($a['correo']); ?>"
                                        class="mt-auto text-blue-600 dark:text-blue-400 font-medium 
    ...
    <?php if (!empty($contactos)) : ?>
        <section class="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-800 dark:to-gray-700 py-16 px-4 transition-colors duration-300" aria-labelledby="contactos-generales-title">
            <div class="max-w-6xl mx-auto">
                ...
                $contact_url = !empty($contact_pages) ? get_permalink($contact_pages[0]->ID) : home_url('/');
                ?>
                <div class="text-center mt-12 animate-fade-in-up" style="animation-delay: <?= $delay + 100 ?>ms">
                    <a href="<?php echo esc_url($contact_url); ?>"
                        class="cta-button inline-flex items-center bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white font-semibold py-3 px-8 rounded-lg transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg font-plus-jakarta">
                        Contáctanos
                    </a>
                </div>
