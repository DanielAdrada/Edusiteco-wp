...
<main id="primary" class="site-main">
    ...
    <section class="relative h-[50vh] bg-cover bg-gradient-custom flex items-center justify-center text-white"
        ...
        <div class="relative z-10 text-center px-4 animate-fade-in-up">
            ...
            <p class="text-xl md:text-2xl opacity-90">
                ...
                echo esc_html__('Formando generaciones con valores', 'edusiteco');
                ?>
            </p>
        </div>
    </section>
    ...
    <?php
    // Obtener datos guardados en el plugin
    ...
    <?php if (!empty($historia)) : ?>
        ...
        <!-- ===================== -->
        <section class="py-16 md:py-24 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h2 class="text-3xl lg:text-4xl font-bold text-text-light dark:text-text-dark font-display mb-8">
                    Nuestra Historia
                </h2>

                <div class="bg-gray-50 dark:bg-gray-900 rounded-2xl shadow-lg p-8 md:p-12 border border-gray-200 dark:border-gray-700">
                    <p class="text-lg md:text-xl leading-relaxed text-text-light dark:text-text-dark">
                        <?php echo wp_kses_post(nl2br($historia)); ?>
                    </p>
                </div>
            </div>
        </section>
                        ...
                        <div
                            ...
                            <div class="flex items-center mb-4">
                                <div
                                    ...
                                    📘
                                    <?php // Puedes cambiar por $hito['icono'] si quieres que el plugin defina el icono 
                                    ?>
                                </div>

                                <span class="text-2xl font-bold text-primary">
                                    <?php echo esc_html($hito['año']); ?>
                                </span>
                            </div>

                            <h3 class="text-xl font-bold text-text-light dark:text-text-dark mb-3 group-hover:text-primary transition-colors">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    <?php foreach ($logros as $logro): ?>
                        <div
                            class="group bg-white rounded-xl p-6 text-center shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">

                            <div
                                class="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 text-3xl">
                                <?php echo esc_html($logro['icono'] ?? '🏅'); ?>
                            </div>

                            <h3 class="font-bold text-xl mb-2 text-black">
                                <?php echo esc_html($logro['titulo']); ?>
                            </h3>

                            <p class="text-gray-700 text-sm">
                                <?php echo esc_html($logro['descripcion']); ?>
                            </p>
                        </div>
                    <?php endforeach; ?>
                </div>
