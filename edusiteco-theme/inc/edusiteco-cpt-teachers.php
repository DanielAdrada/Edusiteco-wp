...
function edusiteco_add_profesor_caps_to_admin() {
    $admin = get_role('administrator');
    if (!$admin) return;

    $caps = [
        'read_profesor',
        'read_private_profesores',

        'edit_profesor',
        'edit_profesores',
        'edit_others_profesores',
        'edit_published_profesores',

        'publish_profesores',

        'delete_profesor',
        'delete_profesores',
        'delete_others_profesores',
        'delete_published_profesores',
    ];
...
add_action('init', 'edusiteco_add_profesor_caps_to_admin');
