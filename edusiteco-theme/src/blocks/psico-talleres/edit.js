                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="mb-2">
                                            <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">
                                                {__('Archivo del taller (PDF)', 'edusiteco')}
                                            </label>

                                            <MediaUploadCheck>
                                                <MediaUpload
                                                    allowedTypes={['application/pdf']}
                                                    onSelect={(media) => updateItem(i, 'pdf', media.url)}
                                                    render={({ open }) => (
                                                        <Button
                                                            onClick={open}
                                                            variant="secondary"
                                                        ...
                                                        >
                                                            {item.pdf ? __('Cambiar PDF', 'edusiteco') : __('Subir PDF', 'edusiteco')}
                                                        </Button>
                                                    )}
                                                />
                                            </MediaUploadCheck>
                                            ...
                                            {item.pdf && (
                                                <p className="text-xs text-green-600 mt-1 truncate">
                                                    📄 {__('PDF cargado correctamente', 'edusiteco')}
                                                </p>
                                            )}
                                        </div>
